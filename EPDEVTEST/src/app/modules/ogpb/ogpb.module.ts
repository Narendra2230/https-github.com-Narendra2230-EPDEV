...
import { Confirmomponent } from './../ogpb/screens/landing/landing.component';
...
@NgModule({
  declarations: [
    ...
    CommentPopup, Teamratepopup, keyInfoPopup, MeasureReplacepopup, NumericDirective, Ricediscussitionppup, ExecutiveEvaluationComponent, ExecutiveComponent, GetExecutiveDashboardComponent
  ],
  imports: [
    CommonModule,
    OgpbRouts,
