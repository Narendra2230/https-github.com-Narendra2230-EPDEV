...
const routes: Routes = [
  ...
  { path: 'my-sapes', component: LandingComponent },
  { path: 'my-team-sapes', component: MyTeamOgpbComponent },
  { path: 'ogpb-evaluation-sapes/:id', component: OgpbEvaluationComponent },
  { path: 'assign-goals-band-sapes', component: AssignGoalsBandComponent },
  { path:'executive-evaluation-sapes', component:ExecutiveEvaluationComponent} 
