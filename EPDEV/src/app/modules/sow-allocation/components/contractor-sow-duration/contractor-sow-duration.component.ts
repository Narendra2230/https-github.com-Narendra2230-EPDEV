...
@Component({
  selector: "app-contractor-sow-duration",
  templateUrl: "./contractor-sow-duration.component.html",
  styleUrls: ["./contractor-sow-duration.component.css"],
})
export class ContractorSowDurationComponent implements OnInit {
  totalhours: number = 0;
