...
export class AllocationService {
  ...
  GetFTADurationList(tempStartDate, tempEndDate): Observable<any[]> {
    return this._http.post<any[]>(
      `${APP_CONSTANTS.apiHost}/project/GetSOWFTADurationDetails`,
      {
        StartDate: tempStartDate,
        EndDate: tempEndDate,
      },
  ...
  GetDurationFTAEMPSOWList(startDate, endDate): Observable<any[]> {
    return this._http.post<any[]>(
      `${APP_CONSTANTS.apiHost}/project/GetFTAEMPSOWDurationDetails`,
      {
        StartDate: startDate,
        EndDate: endDate,
      },
